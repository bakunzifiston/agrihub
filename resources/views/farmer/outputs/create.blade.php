<x-tenant-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Output</h2>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 max-w-2xl">
        <form method="POST" action="{{ route('farmer.outputs.store') }}">
            @csrf
            @include('farmer.outputs._form', ['output' => null])
            <div class="mt-6 flex gap-4">
                <x-primary-button>Add Output</x-primary-button>
