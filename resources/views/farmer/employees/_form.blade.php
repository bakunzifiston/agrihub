...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <x-text-input id="role" name="role" type="text" class="mt-1 block w-full" :value="old('role', $employee?->role)" placeholder="e.g. Farm worker, Driver" />
    ...
    <div>
        ...
        <select id="employment_type" name="employment_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary">
            ...
            @foreach (\App\Models\FarmerEmployee::EMPLOYMENT_TYPES as $value => $label)
