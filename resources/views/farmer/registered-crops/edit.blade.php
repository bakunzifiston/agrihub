<x-tenant-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Registered Crop</h2>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('farmer.registered-crops.update', $registeredCrop) }}">
                    @csrf
                    @method('PATCH')
                    @include('farmer.registered-crops._form', ['registeredCrop' => $registeredCrop])
