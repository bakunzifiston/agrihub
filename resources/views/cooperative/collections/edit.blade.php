<x-tenant-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 max-w-2xl">
        <form method="POST" action="{{ route('cooperative.collections.update', $collection) }}">
            @csrf
            @method('PATCH')
            @include('cooperative.collections._form', ['collection' => $collection])
            <div class="mt-6 flex gap-4">
                <x-primary-button>Update Collection</x-primary-button>
