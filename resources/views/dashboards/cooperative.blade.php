<x-tenant-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <p class="text-gray-600">Use the sidebar to navigate between features and their tables. Each feature contains one or more data tables for managing your cooperative.</p>
        </div>
    </div>
</x-tenant-layout>
